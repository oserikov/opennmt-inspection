...
class RNNDecoderBase(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None,
                intervention=None, dump_layers=False,
                step=None):
        """
        Args:
        ...
        if dump_layers:
            decoder_final, decoder_outputs, attns, dumped_layers =\
                self._run_forward_pass(tgt, memory_bank,
        ...
        if dump_layers:
            return decoder_outputs, state, attns, dumped_layers
        else:
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, state, memory_lengths=None,
        ...
        for _, emb_t in enumerate(emb.split(1)):
            ...
            rnn_output, hidden = self.rnn(decoder_input, hidden, intervention)
